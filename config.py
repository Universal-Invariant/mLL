...
def google_to_stanza(g_code):
    mapping = {"zh-CN": "zh-hans", "zh-TW": "zh-hant", "pt-BR": "pt",
               "pt-PT": "pt", "no": "no_bokmaal", "he": "he", "iw": "he"}
...
def get_edge_voices():
    ...
    try:
        ...
        with open(CACHE_FILE, 'w', encoding='utf-8') as f:
            json.dump(voices_by_locale, f, indent=2)
...
if __name__ == "__main__":
    ...
    for name in test_names:
        try:
            ...
            print(
                f"✅ '{name}' successfully resolved to '{name}' -> Google: {codes['google']}, Stanza: {codes['stanza']}")
